# -*- coding: utf-8 -*-
"""
Created on Mon Dec 20 13:16:27 2021
...
class env_Poly:
    def __init__(self, date_time, date_t):
        ...
        #Linear
        self.reg = Pipeline([('poly', PolynomialFeatures(degree=1)),('linear', LinearRegression(fit_intercept=False))])
